...
export default function ContactClient() {
  ...
  return <ContactContentInternal />
}

function ContactContentInternal() {
  const t = useTranslations()
  const { businessEmail, businessPhone, businessWhatsapp, businessLocation, isReady } = useSiteSettings()
